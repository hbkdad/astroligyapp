...
output "feedback_worker_service_name" { value = aws_ecs_service.feedback_worker.name }
output "feedback_worker_log_group_name" { value = aws_cloudwatch_log_group.feedback_worker.name }
output "feedback_worker_assign_public_ip" { value = aws_ecs_service.feedback_worker.network_configuration[0].assign_public_ip }
output "feedback_worker_readonly_root_filesystem" { value = nonsensitive(jsondecode(aws_ecs_task_definition.feedback_worker.container_definitions)[0].readonlyRootFilesystem) }
output "feedback_worker_task_role_arn" { value = aws_iam_role.feedback_worker_task.arn }
