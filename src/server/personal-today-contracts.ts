export const PERSONAL_TODAY_CONTRACT_VERSION = "1.0.0";

export interface PersonalTodayCommand {
  readonly version: typeof PERSONAL_TODAY_CONTRACT_VERSION;
  readonly profileId: string;
  readonly birthProfileId: string;
  readonly revision: number;
}

export function validatePersonalTodayCommand(
  value: unknown,
): PersonalTodayCommand | null {
  if (
    !record(value) ||
